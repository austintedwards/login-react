...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/capture-stack-trace/index.js";
...
<span class="hljs-built_in">module</span>.exports = <span class="hljs-built_in">Error</span>.captureStackTrace || <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">error</span>) </span>{
	...
	<span class="hljs-built_in">Object</span>.defineProperty(error, <span class="hljs-string">'stack'</span>, {
		...
		<span class="hljs-attr">get</span>: <span class="hljs-function"><span class="hljs-keyword">function</span> <span class="hljs-title">getStack</span>(<span class="hljs-params"></span>) </span>{
			...
			<span class="hljs-built_in">Object</span>.defineProperty(<span class="hljs-keyword">this</span>, <span class="hljs-string">'stack'</span>, {
