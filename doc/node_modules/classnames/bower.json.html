...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/classnames/bower.json";
...
<table cellpadding="0" cellspacing="0">
  ...
  <a class="pilcrow" href="#section-1" id="section-1"></a>
        ...
        <td class="code highlight">
          <pre class="json">{
  <span class="hljs-attr">"name"</span>: <span class="hljs-string">"classnames"</span>,
  <span class="hljs-attr">"version"</span>: <span class="hljs-string">"2.2.5"</span>,
  <span class="hljs-attr">"description"</span>: <span class="hljs-string">"A simple utility for conditionally joining classNames together"</span>,
  <span class="hljs-attr">"main"</span>: [
    <span class="hljs-string">"index.js"</span>,
    <span class="hljs-string">"bind.js"</span>,
    <span class="hljs-string">"dedupe.js"</span>
  ],
  <span class="hljs-attr">"homepage"</span>: <span class="hljs-string">"https://github.com/JedWatson/classnames"</span>,
  <span class="hljs-attr">"authors"</span>: [
    <span class="hljs-string">"Jed Watson"</span>
  ],
