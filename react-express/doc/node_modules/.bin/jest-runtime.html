...
<span class="hljs-keyword">if</span> (process.env.NODE_ENV == <span class="hljs-literal">null</span>) {
  process.env.NODE_ENV = <span class="hljs-string">'test'</span>;
}

<span class="hljs-built_in">require</span>(<span class="hljs-string">'../build/cli'</span>).run();
