...
<p>Expandable buffer that we can provide a size hint for</p>
  ...
  <span class="hljs-keyword">this</span>.buf = <span class="hljs-keyword">new</span> Buffer(nextPow2(initsize || <span class="hljs-number">8192</span>));
...
<p>Allocate a replacement and copy it in</p>
        ...
        <td class="code highlight">
          <pre class="javascript">  <span class="hljs-keyword">var</span> buf = <span class="hljs-keyword">new</span> Buffer(nextPow2(<span class="hljs-keyword">this</span>.buf.length + size - <span class="hljs-keyword">this</span>.writeAvail()));
...
to the other, returning a new buffer with the resultant data</p>
  ...
  <span class="hljs-keyword">var</span> swap = <span class="hljs-keyword">new</span> Buffer(buf.length);
