...
<head>
  ...
  <script>
    var relativeDir = "../../";
    var thisFile = "node_modules/ansi-align/README.md";
...
<body>
  <div id="sidebar_wrapper">
    ...
    <div id="headings">
      ...
      <div class="heading h1">
        <a href="#ansi-align">ansi-align</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#ansialign-text-opts">ansiAlign(text, [opts])</a>
      </div>
      ...
      <div class="heading h3">
        <a href="#ansialign.center-text">ansiAlign.center(text)</a>
      </div>

      <div class="heading h3">
        <a href="#ansialign.right-text">ansiAlign.right(text)</a>
      </div>

      <div class="heading h3">
        <a href="#ansialign.left-text">ansiAlign.left(text)</a>
      </div>

      <div class="heading h2">
        <a href="#similar-packages">Similar Packages</a>
      </div>
  ...
  <div id="container">
    <div class="docs markdown"><div class="pilwrap" id="ansi-align">
  <h1>
    <a href="#ansi-align" name="ansi-align" class="pilcrow"></a>
ansi-align
  </h1>
</div>
<blockquote>
...
<pre><code class="sh">npm install --save ansi-align
</code></pre>
<pre><code class="js"><span class="hljs-keyword">var</span> ansiAlign = <span class="hljs-built_in">require</span>(<span class="hljs-string">'ansi-align'</span>)
</code></pre>
...
<div class="pilwrap" id="ansialign-text-opts">
  <h3>
    <a href="#ansialign-text-opts" name="ansialign-text-opts" class="pilcrow"></a>
<code>ansiAlign(text, [opts])</code>
  </h3>
</div>
...
<div class="pilwrap" id="ansialign.center-text">
  <h3>
    <a href="#ansialign.center-text" name="ansialign.center-text" class="pilcrow"></a>
<code>ansiAlign.center(text)</code>
  </h3>
</div>
<p>Alias for <code>ansiAlign(text, { align: 'center' })</code>.</p>
<div class="pilwrap" id="ansialign.right-text">
  <h3>
    <a href="#ansialign.right-text" name="ansialign.right-text" class="pilcrow"></a>
<code>ansiAlign.right(text)</code>
  </h3>
</div>
<p>Alias for <code>ansiAlign(text, { align: 'right' })</code>.</p>
<div class="pilwrap" id="ansialign.left-text">
  <h3>
    <a href="#ansialign.left-text" name="ansialign.left-text" class="pilcrow"></a>
<code>ansiAlign.left(text)</code>
  </h3>
</div>
<p>Alias for <code>ansiAlign(text, { align: 'left' })</code>, which is a no-op.</p>
<div class="pilwrap" id="similar-packages">
  <h2>
    <a href="#similar-packages" name="similar-packages" class="pilcrow"></a>
Similar Packages
  </h2>
</div>
<ul>
