...
<p>Example (Extra space between slashes added to solve Safari bug. Exclude space in production):
/ /# sourceMappingURL=foo.js.map           /*# sourceMappingURL=foo.js.map */</p>
...
Converter.prototype.addProperty = <span class="hljs-function"><span class="hljs-keyword">function</span> (<span class="hljs-params">key, value</span>) </span>{
  <span class="hljs-keyword">if</span> (<span class="hljs-keyword">this</span>.sourcemap.hasOwnProperty(key)) <span class="hljs-keyword">throw</span> <span class="hljs-keyword">new</span> <span class="hljs-built_in">Error</span>(<span class="hljs-string">'property %s already exists on the sourcemap, use set property instead'</span>);
